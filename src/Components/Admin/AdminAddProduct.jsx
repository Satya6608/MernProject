                    ...
                    <div className="col-md-9 col-12">
                        ...
                        <form onSubmit={postData}>
                            <div className="control-group mb-3">
                                ...
                                <input type="text" className="form-control" id="name" name='name' onChange={getData} placeholder="Your Product Name" required />
                            </div>
                            ...
                            <div className="row mb-3">
                                <div className="col-md-6 col-12">
                                    ...
                                    <input type="text" name="color" onChange={getData} required placeholder="Enter Color " className='form-control' />
                                </div>
                                <div className="col-md-6 col-12">
                                    <label htmlFor="color" className='form-label'>Size<span className='text-danger'>*</span></label>
                                    <input type="text" name="size" onChange={getData} required placeholder="Enter Size " className='form-control' />
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-md-6 col-12">
                                    <label htmlFor="color" className='form-label'>Base Price<span className='text-danger'>*</span></label>
                                    <input type="number" name="baseprice" onChange={getData} required placeholder="Enter Base Price " className='form-control' />
                                </div>
                                <div className="col-md-6 col-12">
                                    <label htmlFor="color" className='form-label'>Discount<span className='text-danger'>*</span></label>
                                    <input type="number" name="discount" onChange={getData} required placeholder="Enter Discount  " className='form-control' />
                                </div>
                            </div>
                            <div className="mb-3">
