...
export default function AdminUpdateBrand() {
    ...
    useEffect(()=>{
        var data = brand.find((item)=>item.id===Number(id))
        if(data)
        setname(data.name)
    },[brand])
    return (
                    ...
                    <div className="col-md-9 col-12">
                        ...
                        <form onSubmit={postData}>
                                <div className="control-group mb-3">
                                    <input type="text" className="form-control" id="name" name='name' onChange={getData} placeholder="Your Brand Name" required value={name}/>
                                </div>
                                <div>
